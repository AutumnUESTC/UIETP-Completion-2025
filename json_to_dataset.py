...
if __name__ == '__main__':
    jpgs_path   = "E:/yby/lab/Dataset/JPEGImages"
    pngs_path   = "E:/yby/lab/Dataset/SegmentationClassPNG"
    ...
    classes     = ["_background_", "icedTower", "icedCamera", "icedCameraSnow", "icedCameraFog", "coverdCamera"]
    
    count = os.listdir("E:/yby/lab/IceDataset/before/SegmentationClass")
    for i in range(0, len(count)):
        path = os.path.join("E:/yby/lab/IceDataset/before/SegmentationClass", count[i])
